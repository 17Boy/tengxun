  ...
  render() {
    return (<section>
      ...
      {this.props.listData.map((item, index) => {
        ...
        return (<div className='data-structures' key={index}>
      ...
      <div className='mask-layer' style={{ display: this.state.maskLayer ? 'block' : 'none' }} onClick={() => this.setState({ isRun: 0, maskLayer: !this.state.maskLayer })} ></div>
    </section>);
  }
